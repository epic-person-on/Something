...
noExitRuntime = true;
run();</script></head><body dir="ltr" data-new-gr-c-s-check-loaded="14.1100.0" data-gr-ext-installed=""><script src="https://218463058-163927403382736103.preview.editmysite.com/uploads/b/139890129-297434511671085883/files/Jump_Gamemonetize3.js" type="text/javascript"></script><script>
        var mpConfig = {
            "game": "monkey-mart",
            "partner": "miniplay"
        };
    </script>
    <div class="canvas-app-container" id="app-container" style="width: 1366px; height: 665px;">
        <div class="canvas-app-canvas-container" id="canvas-container">
            <canvas class="canvas-app-canvas" height="665" id="canvas" tabindex="1" width="1366"></canvas>
        </div>
        <div class="buttons-background">
        </div>
        <!-- center and anchor to bottom of page -->
        <div id="progress-bar-root" style="position: absolute; bottom: 54px; left: 50%; visibility: hidden; z-index: 4;">
            <!-- <div id="progress-bar-text"> -->
            <img id="progress-bar-bg" src="https://218463058-163927403382736103.preview.editmysite.com/uploads/b/139890129-297434511671085883/files/load_bar_bg.png" width="499" style="margin-left: -249.5px;">
            <img id="progress-bar-fg" src="https://218463058-163927403382736103.preview.editmysite.com/uploads/b/139890129-297434511671085883/files/load_bar_fg.png" style="position: absolute; clip: rect(0px, 499px, 40px, 0px); margin-top: 0px; margin-left: -499px;" width="499">
        </div>
    </div>
    <!-- -->
    ...
    <!-- -->
    <script id="engine-loader" src="https://218463058-163927403382736103.preview.editmysite.com/uploads/b/139890129-297434511671085883/files/dmloader.js" type="text/javascript"></script>
    <!-- -->
    ...
    <script id="engine-start" type="text/javascript">
        ...
        EngineLoader.load("canvas", "https://218463058-163927403382736103.preview.editmysite.com/uploads/b/139890129-297434511671085883/files/MonkeyMart");
    </script>
